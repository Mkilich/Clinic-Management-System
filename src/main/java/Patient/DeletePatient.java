...
public class DeletePatient extends javax.swing.JFrame {
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        int response = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete the patient with ID " + search + "?", "Confirm Deletion", JOptionPane.YES_NO_OPTION);
    ...
    private void deletePatient(String search) {
        connection = Connector.ConnectDb();
