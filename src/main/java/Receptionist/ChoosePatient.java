...
import Main.Clinic;
import Receptionist.ChoosePatient;
...
public class ChoosePatient extends javax.swing.JFrame {
    ...
    public ChoosePatient() {
        ...
        Object columns[] = {"Id", "Name", "Disease", "Blood", "Room Number", "Age", "Gender", "Phone Number", "Date", "Address", "Status"};
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        String sql = "select id,name,disease,blood,room,age,gender,phone,date,address,status from patient where name = '" + searchKey + "'";
        try {
    ...
    private void dASearchbtn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtn1MouseClicked
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Error: " + e.getMessage()); // Show the error message
        } finally {
            try {
                 if (ps != null) {
