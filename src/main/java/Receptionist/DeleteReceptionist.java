...
public class DeleteReceptionist extends javax.swing.JFrame {
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Receptionist id " + search + " not found");
        }
    }//GEN-LAST:event_jPanel1MouseClicked

    private void rDeletebtnMouseClicked(java.awt.event.MouseEvent evt) {                                        
    	 connection = Connector.ConnectDb();
         String search = rDeleteField.getText();
         String sql = "Delete from receptionist where id =?";
         try {
             int response = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete the receptionist with Name " + search + "?", "Confirm Deletion", JOptionPane.YES_NO_OPTION);
