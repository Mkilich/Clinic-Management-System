...
public class NewPatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pBloodField = new javax.swing.JTextField();
        ...
        addPatientbtn.getAccessibleContext().setAccessibleDescription("");
        ...
        pBloodField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pBloodFieldActionPerformed(evt);
            }
        });

        Gender1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        Gender1.setForeground(new java.awt.Color(0, 153, 153));
        Gender1.setText("Blood");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(pBloodField, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(pBloodField, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addPatientbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPatientbtnMouseClicked
        ...
        if (connection != null) {
            ...
            String blood = pBloodField.getText();
            ...
            String sql = "insert into patient(address, age, blood, date, disease, gender, id, name, phone, room, status) values (?,?,?,STR_TO_DATE(?, '%d-%m-%Y'),?,?,?,?,?,?,?)";
            try {
                prp = connection.prepareStatement(sql);
                prp.setString(1, address);
                prp.setInt(2, age);
                prp.setString(3, blood);
                prp.setString(4, date);
                prp.setString(5, disease);
                prp.setString(6, gender);
                prp.setString(7, id);
                prp.setString(8, name);
                prp.setString(9, phone);
                prp.setInt(10, room);
                prp.setString(11, status);
                prp.execute();
    ...
    private void pBloodFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pBloodFieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_pBloodFieldActionPerformed
    ...
    private javax.swing.JTextField pBloodField;
