...
public class SearchReceptionist extends javax.swing.JFrame {
    ...
    public SearchReceptionist() {
        ...
        Object columns[] = {"Id", "Name","Surname", "Age", "Gender", "Blood Group", "Phone Number", "E-Mail", "Status", "Address", "Username"};
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        String sql = "select id,name,surname,age,gender,blood,phone,email,status,address,username from receptionist where id = '" + searchKey + "'";
        try {
