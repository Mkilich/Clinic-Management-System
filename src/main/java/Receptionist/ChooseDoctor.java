...
import Main.Clinic;
import Receptionist.ChooseDoctor;
...
public class ChooseDoctor extends javax.swing.JFrame {
    ...
    public ChooseDoctor() {
        ...
        Object columns[] = {"Name", "Age", "Gender", "Blood Group", "Department", "Email Address", "Status", "Address", "Phone Number", "Room", "Username"};
    ...
    private void initComponents() {
        ...
        doctorhind.setForeground(new java.awt.Color(0, 153, 153));
    ...
    private void dASearchbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtnMouseClicked
        ...
        String sql = "select name,age,gender,blood,dept,phone,email,status,address,room,username from doctor where dept = '" + searchKey + "'";
        try {
    ...
    private void dASearchbtn1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtn1MouseClicked
        ...
        int room = Integer.parseInt(apTable.getValueAt(row, 9).toString());
