...
public class DeleteDoctor extends javax.swing.JFrame {
    ...
    private void dDeletebtnMouseClicked(java.awt.event.MouseEvent evt) {   
        connection = Connector.ConnectDb();
        String search = dDeleteField.getText();
        String sql = "Delete from doctor where id =?";
        try {
            int response = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete the doctor with ID " + search + "?", "Confirm Deletion", JOptionPane.YES_NO_OPTION);
